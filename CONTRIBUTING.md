...
Welcome to `medprompt` contributor's guide.
...
If you experience bugs or general issues with `medprompt`, please have a look
...
You can help improve `medprompt` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`medprompt` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `medprompt`'s files. While this mechanism can
...
```
conda create -n medprompt python=3 six virtualenv pytest pytest-cov
conda activate medprompt
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/medprompt.git
   cd medprompt
   ```
...
5. Install [pre-commit]:
   ...
   `medprompt` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/medprompt
[issue tracker]: https://github.com/<USERNAME>/medprompt/issues
